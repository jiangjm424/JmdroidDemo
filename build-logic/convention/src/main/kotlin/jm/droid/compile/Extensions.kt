...
val Project.minSdk: Int
    get() = intProperty("minSdk") ?: 26

val Project.targetSdk: Int
    get() = intProperty("targetSdk") ?: 31

val Project.compileSdk: Int
    get() = intProperty("compileSdk") ?: 31

val Project.groupId: String
    get() = stringProperty("GROUP") ?: "io.github.jiangjm424"

val Project.versionName: String
    get() = stringProperty("VERSION_NAME") ?: "9.99.999"
...
private fun Project.intProperty(name: String): Int? {
    return (findProperty(name) as? String)?.toInt()
}
